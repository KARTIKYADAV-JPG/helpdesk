...
return [
    ...
    'dsn' => (env('APP_ENV') === 'production' || env('SENTRY_TEST_LOCAL', false))
    ...
    /*
    |--------------------------------------------------------------------------
    | Sanitization & Data Scrubbing Callbacks
    |--------------------------------------------------------------------------
    |
    | These callbacks allow you to sanitize sensitive credentials, passwords,
    | database passwords, and other user data before it is sent to Sentry.
    |
    */
    'before_send' => [\App\Exceptions\SentrySanitizer::class, 'beforeSend'],
    'before_send_transaction' => [\App\Exceptions\SentrySanitizer::class, 'beforeSendTransaction'],
